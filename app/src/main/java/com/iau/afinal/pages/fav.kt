...
@Composable
fun FavPage(navController: NavHostController, viewModel: FavViewModel) {
    Scaffold(
        topBar = {},
        bottomBar = {
...
@Composable
fun HotelsList(navController: NavHostController, viewModel: FavViewModel, pad: PaddingValues) {
...
@Composable
fun HotelItem(hotel: HotelR, navController: NavHostController, viewModel: FavViewModel) {
